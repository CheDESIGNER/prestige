...
<form action="" method="POST" enctype="multipart/form-data" id="form-topic-add">
	...
	<p>
	    ...
	    <input type="text" id="topic_title" name="topic_title" value="{$_aRequest.topic_title}" class="input-text style-1 input-width-full" {if $bEditDisabled}readonly="readonly"{/if} /><br />
        <small class="note">{$aLang.topic_question_create_title_notice}</small>
	</p>
	...
	<p>
	    ...
	    <input type="text" id="topic_tags" name="topic_tags" value="{$_aRequest.topic_tags}" class="input-text style-1 input-width-full autocomplete-tags-sep" />
