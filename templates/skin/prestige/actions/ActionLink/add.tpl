...
<form action="" method="POST" enctype="multipart/form-data" id="form-topic-add">
	...
	<p>
        ...
        <select name="blog_id" id="blog_id" onChange="ls.blog.loadInfo(jQuery(this).val());" class="input-width-full style-1">
	...
	<p>
	    ...
	    <input type="text" id="topic_title" name="topic_title" value="{$_aRequest.topic_title}" class="input-text style-1 input-width-full" />
	...
	<p>
	    ...
	    <input type="text" id="topic_link_url" name="topic_link_url" value="{$_aRequest.topic_link_url}" class="input-text style-1 input-width-full" />
	...
	<p>
	    ...
	    <input type="text" id="topic_tags" name="topic_tags" value="{$_aRequest.topic_tags}" class="input-text style-1 input-width-full autocomplete-tags-sep" /><br />
