...
<div class="nav-filter-wrapper">
	<ul class="nav nav-filter">
        ...
        <li class="creat-nav">
            <a href="#">{$aLang.prest_txt_8} <i class="caret-pre"></i></a>
        </li>

        {hook run='menu_blog'}

		<li class="popular-nav">
			<a href="{cfg name='path.root.web'}/">{$aLang.prest_txt_7} <i class="caret-pre"></i></a>

            {if $sMenuItemSelect=='index'}
                <ul class="nav nav-filter nav-filter-sub" style="display: none;">
        ...
        <li class="tag-nav">
            <a href="#">{$aLang.prest_txt_9} <i class="caret-pre"></i></a>
        </li>
